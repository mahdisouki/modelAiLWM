...
def update_predictions(prediction_list, prices):
    for prediction in prediction_list:
        ...
        for price_item in prices:
            if (prediction.classe.lower() in price_item.lower()) or (price_item.lower() == prediction.classe.lower()):
...
def calculate_total_price(predictions, prices):
    ...
    for pred in predictions:
        ...
        for csv_class in prices.keys():
            if (class_name.lower() in csv_class.lower()) or (csv_class.lower() == class_name.lower()):  # Case-insensitive matching
